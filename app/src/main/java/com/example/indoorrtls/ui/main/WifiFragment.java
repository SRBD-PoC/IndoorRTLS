...
public class WifiFragment extends Fragment implements WifiScanner.OnScanResultListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getWifiScanResults().observe(getViewLifecycleOwner(), results -> adapter.setScanResults(results));
    }
    ...
    public void onResultsAvailable(List<ScanResult> results) {
        mViewModel.updateWifiScanResults(results);
    }
